...
<div class="top-container">
    <div class="container">
        ...
        <table class="table table-striped mt-5 table-hover">
            ...
            <c:if test="${not empty user}">
                <tr>
                    ...
                    <td>${user.get().selfBio}</td>
                    <td><img src="data:image/png;base64,${user.get().photoString}" alt="Photo"/></td>
                    <td>${user.get().role}</td>
        ...
        <div class="container bottom-buttons">
            ...
            <div class="mt-3">
                <a href="${pageContext.request.contextPath}/api/user/userIndex" class="btn btn-primary">Back To Index</a>
            </div>
        </div>
    </div>
    <div>
...
<div class="modal" id="editUserModal" tabindex="-1" role="dialog" aria-labelledby="editUserModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="editUserForm" action="${pageContext.request.contextPath}/api/user/editUser" method="post" enctype="multipart/form-data">
