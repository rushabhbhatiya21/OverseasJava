...
<div class="dynamic-content">
    <div class="topWithButtons">
        ...
        <div>
            <button class="btn btn-primary" type="button" onclick="populate('addOffer')">Add Offer</button>
        </div>
    </div>
                    ...
                    <c:when test="${content.size() > 0}">
                        <c:forEach var="complaint" items="${content}" varStatus="ind">
                            <tr align="center">
                                ...
                                <td>
                                    <a href="editOffer/${complaint.offerId}" class="btn btn-outline-info btn-sm">Edit</a>
