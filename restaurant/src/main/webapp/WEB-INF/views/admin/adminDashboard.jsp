    ...
    <div>
        ...
        <div class="main-cont">
            <div class="main-left-cont">
                ...
                <div class="main-left-content-card" id="manageCity">
                ...
                <div class="main-left-content-card" id="manageArea">
                    <div class="main-left-content-card-left">
                ...
                <div class="main-left-content-card" id="manageCategory">
                    <div class="main-left-content-card-left">
                ...
                <div class="main-left-content-card" id="manageSubCategory">
                    <div class="main-left-content-card-left">
                        <i class="fa-solid fa-layer-group margin-sm-right"></i>
                ...
                <div class="main-left-content-card" id="manageRestaurant">
                    <div class="main-left-content-card-left">
                        <i class="fa-solid fa-utensils margin-sm-right"></i>
                        <span>Manage Restaurant</span>
                    </div>
                </div>
                <div class="main-left-content-card" id="manageOffers">
                    <div class="main-left-content-card-left">
                        <i class="fa-solid fa-bag-shopping margin-sm-right"></i>
                        <span>Manage Offers</span>
                    </div>
                </div>
                <div class="main-left-content-card" id="manageComplaints">
                    <div class="main-left-content-card-left">
                        <i class="fa-solid fa-phone-flip margin-sm-right"></i>
                        <span>Manage Complaint</span>
                    </div>
                </div>
                <div class="main-left-content-card" id="manageFeedback">
                    <div class="main-left-content-card-left">
                        <i class="fa-solid fa-thumbs-up margin-sm-right"></i>
